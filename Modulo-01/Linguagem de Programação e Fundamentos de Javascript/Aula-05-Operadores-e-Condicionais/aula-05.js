...
nome = "Emerson"; // caso não seja especificado, criará uma variável global, n deve ser utilizada
let nome = "Emerson"; //declaração padrão
var name = "Penelli"; //bastante antigo
...
const autenticacao = usuario === "Emerson" && senha === "12345";
